        ...
        {showAllUsers ? (
          <div className="space-y-4 h-full">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 bg-gray-800 border rounded-lg focus-ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
                value={searchQuery}
            ...
            <div className="space-y-4 overflow-auto h-full pb-4">
              {users
                ...
                .map((u) => (
                  <button
                    key={u._id}
                    className="w-full text-left p-4 rounded-lg border border-gray-600 hover:bg-gray-800 transition-colors"
                      ...
                      <div className="flex item-center justify-between mb-1">
                        <span
                          className={`font-semibold truncate ${
                            isSelectedd ? "text-white" : "text-gray-200"
                          }`}
                        >
                          {chat.user.user.name}
                        </span>
          ...
          <div className="flex flex-col items-centter justify-center h-full text-center">
            ...
            <p className="text-sm text-gray-500 mt-1">
              Start a new Chat to bring a messaging
            </p>
          </div>
        )}
      </div>
